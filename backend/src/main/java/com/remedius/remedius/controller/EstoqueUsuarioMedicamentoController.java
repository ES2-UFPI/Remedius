...
public class EstoqueUsuarioMedicamentoController {
    ...
    public ResponseEntity<EstoqueUsuarioMedicamentoEntity> updateEstoqueByMedicationId(
            @PathVariable Long id, @RequestBody EstoqueUsuarioMedicamentoRequest updatedEstoque) {
        EstoqueUsuarioMedicamentoEntity Estoque = EstoqueService.updateEstoqueByMedicationId(id, updatedEstoque);
