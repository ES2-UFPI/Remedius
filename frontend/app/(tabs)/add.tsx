...
const RegisterMedication = () => {
  ...
  const clearFormData = () => {
    setMedication(new MedicationPrototype());
  };

  const onDateChange = ({ date }: { date: Date }) => {
    if (date && validateDate(date)) {
      setMedication(medication.setDataInicial(date));
  ...
  const handleSubmit = async () => {
    ...
    if (!medication.nome.trim() || !medication.dosagem.trim() || !medication.frequencia.trim() || !medication.quantidade.trim()) {
            ...
            <View className="bg-white rounded-2xl p-4 sm:p-6 relative shadow-md">
              ...
              <View className="mb-6">
                ...
                <TextInput
                  ...
                  onChangeText={(nome) => setMedication(medication.setNome(nome))}
                ...
                <TextInput
                  ...
                  onChangeText={(laboratorio) => setMedication(medication.setLaboratorio(laboratorio))}
                ...
                <View className="flex-row gap-2">
                  <TextInput
                    ...
                    onChangeText={(dosagem) => setMedication(medication.setDosagem(dosagem))}
              ...
              <View className="mb-6">
                ...
                <View className="bg-[#F3F3F3] rounded-lg mb-4">
                  <Picker
                    ...
                    onValueChange={(horaInicial) => setMedication(medication.setHorarioInicio(horaInicial))}
                    className='bg-[#F3F3F3] p-3 rounded-lg'
                  >
                ...
                <View className="bg-[#F3F3F3] rounded-lg mb-4">
                  <Picker
                    ...
                    onValueChange={(frequencia) => setMedication(medication.setFrequencia(frequencia))}
                    className='bg-[#F3F3F3] p-3 rounded-lg'
                ...
                <View className="flex-row gap-2">
                  <TextInput
                    ...
                    onChangeText={(duracaoTratamento) => setMedication(medication.setDuracaoTratamento(duracaoTratamento))}
                    keyboardType="numeric"
              ...
              <View className="mb-6">
                ...
                <View className="flex-row gap-2">
                  <TextInput
                    ...
                    onChangeText={(quantidade) => setMedication(medication.setQuantidade(quantidade))}
                    keyboardType="numeric"
                ...
                <TextInput
                  ...
                  onChangeText={(observacao) => setMedication(medication.setObservacao(observacao))}
                  multiline
